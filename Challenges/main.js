...
if(mark.bmi > john.bmi) {
 ...
 console.log(`${john.firstName} value is ${john.bmi} and his the winner`)
  ...
  console.log('No one won!,so who Won!');
}
...
let billVal = 275;
 ...
 let value = tip + billVal;


console.log(`the bill was ${billVal}, the tip was ${tip}, and the total Value ${value} `)
//console.log(Val)

const valueX = value >= 50 && value <= 300 ? "tip" : " No tip";
console.log(valueX)
